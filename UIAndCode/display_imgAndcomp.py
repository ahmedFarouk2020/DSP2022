...
class DisplayImgComp():
    def __init__(self):
        ...
        # path of img1
        path1 = os.path.realpath('../GUI/DSP2022/Task3/images/test1.jpg')
        # path of img2
        path2 = os.path.realpath('../GUI/DSP2022/Task3/images/test2.jpg')
        # path of img1 component
        path3 = os.path.realpath('../GUI/DSP2022/Task3/images/img1comp.png')
        # path of img1 component
        path4 = os.path.realpath('../GUI/DSP2022/Task3/images/img2comp.png')
