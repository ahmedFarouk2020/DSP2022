...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.Img1GroupBox)
        ...
        self.Image1ComboBox.addItem("")
        self.Image1ComboBox.addItem("")
        self.gridLayout_3.addWidget(self.Image1ComboBox, 0, 1, 1, 1)
        self.Image1GraphicsViewerA = QtWidgets.QGraphicsView(self.Img1GroupBox)
        self.Image1GraphicsViewerA.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.Image1GraphicsViewerA.setObjectName("Image1GraphicsViewerA")
        self.gridLayout_3.addWidget(self.Image1GraphicsViewerA, 1, 0, 1, 1)
        self.Image1GraphicsViewerB = QtWidgets.QGraphicsView(self.Img1GroupBox)
        self.Image1GraphicsViewerB.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.Image1GraphicsViewerB.setObjectName("Image1GraphicsViewerB")
        self.gridLayout_3.addWidget(self.Image1GraphicsViewerB, 1, 1, 1, 1)
        ...
        self.gridLayout = QtWidgets.QGridLayout(self.MixerGroupBox)
        ...
        self.gridLayout.addWidget(self.OutputLabel, 0, 3, 1, 1)
        ...
        self.OutputCombobox.addItem("")
        self.gridLayout.addWidget(self.OutputCombobox, 0, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.Component1Label, 1, 0, 1, 1)
        ...
        self.Component1ComboBox1.addItem("")
        self.gridLayout.addWidget(self.Component1ComboBox1, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Component1Slider, 1, 2, 1, 3)
        ...
        self.Component1ComboBox2.addItem("")
        self.Component1ComboBox2.addItem("")
        self.gridLayout.addWidget(self.Component1ComboBox2, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Component1SliderEnd, 2, 4, 1, 1)
        ...
        self.Component2ComboBox1.addItem("")
        self.gridLayout.addWidget(self.Component2ComboBox1, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Component2Slider, 3, 2, 1, 3)
        ...
        self.Component2ComboBox2.addItem("")
        self.Component2ComboBox2.addItem("")
        self.gridLayout.addWidget(self.Component2ComboBox2, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Component2SliderEnd, 4, 4, 1, 1)
        ...
        self.gridLayout_4 = QtWidgets.QGridLayout(self.Img2Groupbox)
        ...
        self.Image2ComboBox.addItem("")
        self.Image2ComboBox.addItem("")
        self.gridLayout_4.addWidget(self.Image2ComboBox, 0, 1, 1, 1)
        self.Image2GraphicsViewerA = QtWidgets.QGraphicsView(self.Img2Groupbox)
        self.Image2GraphicsViewerA.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.Image2GraphicsViewerA.setObjectName("Image2GraphicsViewerA")
        self.gridLayout_4.addWidget(self.Image2GraphicsViewerA, 1, 0, 1, 1)
        self.Image2GraphicsViewerB = QtWidgets.QGraphicsView(self.Img2Groupbox)
        self.Image2GraphicsViewerB.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.Image2GraphicsViewerB.setObjectName("Image2GraphicsViewerB")
        self.gridLayout_4.addWidget(self.Image2GraphicsViewerB, 1, 1, 1, 1)
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(self.OutputGroupBox)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.OutputGraphicsViewer1 = QtWidgets.QGraphicsView(self.OutputGroupBox)
        self.OutputGraphicsViewer1.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.OutputGraphicsViewer1.setObjectName("OutputGraphicsViewer1")
        self.gridLayout_2.addWidget(self.OutputGraphicsViewer1, 0, 0, 1, 1)
        self.OutputGraphicsViewer2 = QtWidgets.QGraphicsView(self.OutputGroupBox)
        self.OutputGraphicsViewer2.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.OutputGraphicsViewer2.setObjectName("OutputGraphicsViewer2")
        self.gridLayout_2.addWidget(self.OutputGraphicsViewer2, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Image_Mixer"))
